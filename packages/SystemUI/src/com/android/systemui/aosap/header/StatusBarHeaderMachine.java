...
package com.android.systemui.aosap.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.aosap.header.STATUS_BAR_HEADER_UPDATE";
